        ...
        <div class="container">
            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/displayFactorizorForm">Factorizor</a></li>
            ...
            <h2>Enter Number to be Factored! (Controller)</h2>
            <form action="enterNumberToBeFactored" method="POST">
                <input type="text" name="numberFactored">
