...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2>What is the Length of the Floor?? (Controller)</h2>
            <form action="calculateCost" method="POST">
                <input type="text" name="floorAreaLength">
                <h2>What is the width?(Controller)</h2>
                <input type="text" name="floorAreaWidth">
                <h2>What is the cost per foot of the material you would like to use?(Controller)</h2>
