...
<html>
    ...
    <body>
        <div>
            ...
            <%@include file="../WEB-INF/jspf/adminpagebodyfragment.jspf"%>
        </div>
        <!-- Placed at the end of the document so the pages load faster -->
        <%@include file="../WEB-INF/jspf/footerfragment.jspf"%>

        <%@include file="../WEB-INF/jspf/pageEditModal.jspf"%>
        ...
        <!--<script src="${pageContext.request.contextPath}/js/loadingPages.js"></script>-->
    </body>
</html>
